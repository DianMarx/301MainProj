...
Loyal\newline
			\item What makes you want to do the project\newline\newline
				I love working with mobile and web development and this project has a mixture of both. It is a very interesting approach to solve the problem of tracking a driver's driving skills and I know that I will gain a lot of knowledge and experience. I will have fun working on this project. \newline
		\end{itemize}
		...
		\begin{itemize}
			...
			Programming languages that I've studied and have used for 4 years include:
								...
								\end{itemize}	
			\item Past experience relevant to project\newline
				I have developed a few Android apps for personal use. Mobile development mainly consist of Java coding, and Java is my favorite language.
			\item Non-technical strengths\newline
			...
			\item What makes you want to do the project\newline
				This is a completely new idea and an intresting way of combining mobile technology with safety. I see a lot of potential in this project and I know we, as a team, can make this project a reality. I would definitely use an app like this for personal use.
		\end{itemize}
	...
	\subsection{Technologies we intend to use for the project}
		...
		\begin{itemize}
								...
								\item Markup Languages\newline
									Such as XML, HTML, XHTML, DTD, XSLT, XPath and TeX.
								\item Web Development Coding\newline
									Such as PHP, Javascript, CSS, AJAX, jNode and ASP.NET.
								\item Database Coding\newline
									Such as SQL, MySQL, MongoDB.
								\end{itemize}
...
6.	Build and deployment scripts or instructions.\newline
7.	Release Notes. \newline
