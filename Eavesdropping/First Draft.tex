...
Loyal\newline
			\item What makes you want to do the project\newline\newline
				I love working with mobile development and web development and this project has a mixture of both. The fact that I have to write a malware application to test the mobile application intrigues me. I will gain a lot of experience and knowledge in the area of  development that I'm most interested in.\newline
		\end{itemize}
		...
		\begin{itemize}
			...
			\item What makes you want to do the project\newline
				This is a completely new idea and a very interesting concept. I always wanted to develop an app for mobile phones to restrict users from using certain functions in certain circumstances, specifically in test environments where students are not allowed to communicate with the outside world while writing tests. I see a lot of potential in this project and would love to be apart of it.
		\end{itemize}
	...
	\subsection{Technologies we intend to use for the project}
		...
		\begin{itemize}
								...
								\item Markup Languages\newline
									Such as XML, HTML, XHTML, DTD, XSLT, XPath and TeX.
								\item Web Development Coding\newline
									Such as PHP, Javascript, CSS, AJAX, jNode and ASP.NET. 								\item Database Coding\newline
									Such as SQL, MySQL, MongoDB.
								\end{itemize}	
	\subsection{What the client will receive from us at the end of the project}
		Firstly, the client can expect an application that listened for the NFC tag, and then makes the required changes upon contact.
		\newline
